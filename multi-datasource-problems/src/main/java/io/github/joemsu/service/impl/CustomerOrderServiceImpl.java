...
public class CustomerOrderServiceImpl implements CustomerOrderService {
    ...
    @Override
    public void getCustomerOne(Long id) {
        CustomerDO customer = customerRepository.getOne(id);
        System.out.println(customer);
    }

    @Override
    public void getOrderOne(Long id) {
        OrderDO order = orderRepository.getOne(id);
